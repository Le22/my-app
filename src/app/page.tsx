    ...
    <main>
      ...
      <div className="flex flex-col gap-20 p-10" id="discover">
        ...
        <p>
          ...
          l’histoire une cérémonie d’ouverture des Jeux Olympiques d’été au cœur
          de la ville, sur la Seine. La plus grande fête du sport au monde, dans
          la plus belle ville du monde !
        </p>
        <p>
          Jamais une cérémonie d’ouverture n’aura été vécue et partagée par
          autant de personnes : au moins 600 000 spectateurs pourront y assister
          depuis les quais et les ponts de la Seine, et environ la moitié des
          accès seront gratuits.
        </p>
        <p>
          La Seine, ses ponts et les monuments de la capitale seront le décor
          d’un spectacle à couper le souffle, où les performances artistiques se
          mêleront aux performances sportives.
        </p>
      </div>
